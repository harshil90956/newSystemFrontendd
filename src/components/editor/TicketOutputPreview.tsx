  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        if (isUserMmMode) {
          mmOverrides.widthMm = ticketCropMm.widthMm;
          mmOverrides.heightMm = ticketCropMm.heightMm;

          if (typeof ticketCropMm.xMm === 'number') mmOverrides.xMm = ticketCropMm.xMm;
          if (typeof ticketCropMm.yMm === 'number') mmOverrides.yMm = ticketCropMm.yMm;
          if (typeof ticketCropMm.cutMarginMm === 'number') mmOverrides.cutMarginMm = ticketCropMm.cutMarginMm;
          if (typeof ticketCropMm.rotationDeg === 'number') mmOverrides.rotationDeg = ticketCropMm.rotationDeg;
          if (typeof ticketCropMm.keepProportions === 'boolean') {
            mmOverrides.keepProportions = ticketCropMm.keepProportions;
          }
          if (ticketCropMm.alignment === 'left' || ticketCropMm.alignment === 'center' || ticketCropMm.alignment === 'right') {
            mmOverrides.alignment = ticketCropMm.alignment;
          }
        }
    ...
    try {
      ...
      const vectorMetadata = {
        ...
        ticketCrop: {
          ...
          widthRatio: ticketCropRatio.widthRatio,
          heightRatio: ticketCropRatio.heightRatio,
          xMm: ticketCropMm?.xMm ?? null,
          yMm: ticketCropMm?.yMm ?? null,
          widthMm: ticketCropMm?.widthMm ?? null,
          heightMm: ticketCropMm?.heightMm ?? null,
          cutMarginMm: ticketCropMm?.cutMarginMm ?? null,
          rotationDeg: ticketCropMm?.rotationDeg ?? null,
          keepProportions: ticketCropMm?.keepProportions ?? null,
          alignment: ticketCropMm?.alignment ?? null,
        },
        layout: {
          pageSize: 'A4',
          totalPages: pages.length,
